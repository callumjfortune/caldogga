  ...
  return (
    <div className="bbc_logo">
      <svg
        ...
        height="auto" // Set responsive height
      >
        <style>{`.st0{fill:#FFFFFF;}`}</style>
        <defs>
          <path id="BBC_Logo_White_RGB_Path" d="M0 0h211.122v60.482H0z" />
        </defs>
        <path
          className="st0"
          d="M64,64v256h256V64H64z M242.5,244.7c-4.4,6.2-10.6,10.9-18.7,14.3c-8.1,3.4-17.8,5-29.2,5h-57.4V120h54
        ...
        <path
          className="st0"
          d="M384,64v256h256V64H384z M562.5,244.7c-4.4,6.2-10.6,10.9-18.7,14.3c-8.1,3.4-17.8,5-29.2,5h-57.4V120h54
          c15.9,0,28.3,3.2,37,9.6c8.7,6.4,13.1,15.5,13.1,27.5c0,6.8-1.6,12.8-4.7,17.8c-3.1,5-7.8,9-13.9,12c8.5,2.8,15,7.3,19.5,13.4
        ...
        <path
          className="st0"
          d="M704,320h256V64H704V320z M887.9,254.9c-6,3.3-12.9,5.9-20.7,7.8c-7.9,1.9-16.1,2.9-24.8,2.9
